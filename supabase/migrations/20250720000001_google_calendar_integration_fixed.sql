-- Migração corrigida para integração com Google Calendar
-- Data: 2025-07-20
...
DROP POLICY IF EXISTS "Users can read own google calendar integrations" ON google_calendar_integrations;
DROP POLICY IF EXISTS "Users can create own google calendar integrations" ON google_calendar_integrations;
DROP POLICY IF EXISTS "Users can update own google calendar integrations" ON google_calendar_integrations;
DROP POLICY IF EXISTS "Users can delete own google calendar integrations" ON google_calendar_integrations;

DROP POLICY IF EXISTS "Users can read own synced events" ON google_calendar_synced_events;
DROP POLICY IF EXISTS "Users can create own synced events" ON google_calendar_synced_events;
DROP POLICY IF EXISTS "Users can update own synced events" ON google_calendar_synced_events;
DROP POLICY IF EXISTS "Users can delete own synced events" ON google_calendar_synced_events;
...
DROP INDEX IF EXISTS google_calendar_integrations_user_id_idx;
DROP INDEX IF EXISTS google_calendar_synced_events_user_id_idx;
DROP INDEX IF EXISTS google_calendar_synced_events_google_event_id_idx;
DROP INDEX IF EXISTS google_calendar_synced_events_activity_id_idx;
